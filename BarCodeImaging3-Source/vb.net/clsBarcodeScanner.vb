...
#Region "General"
  ...
  Private Shared Function verticalHistogram(ByVal bmp As Bitmap, ByVal start As Integer, ByVal [end] As Integer, ByVal direction As ScanDirection) As histogramResult
    ...
    Dim vertSum As UShort() = New UShort(0 To xMax - 1) {}
    ...
    retVal.threshold = DirectCast((minValue + ((maxValue - minValue) >> 1)), Byte)
...
#Region "EAN-specific"
  ...
  Private Shared Function ParseEANPattern(ByVal sPattern As String, ByVal sEANCode As String, ByVal iEANSeparators As Integer) As String
    Dim LRCodes As String() = {"3211", "2221", "2122", "1411", "1132", "1231", _
     "1114", "1312", "1213", "3112"}
    Dim GCodes As String() = {"1123", "1222", "2212", "1141", "2311", "1321", _
     "4111", "2131", "3121", "2113"}
  ...
  Private Shared Function GetEANFirstDigit(ByRef sEANPattern As String) As String
    Dim LGPatterns As String() = {"LLLLLL", "LLGLGG", "LLGGLG", "LLGGGL", "LGLLGG", "LGGLLG", _
      ...
      If sEANPattern.StartsWith("S") Then
        ...
        Select Case sDigits.Length
          ...
          Case 5
            ...
            Next i
            Dim EAN5CheckSumPattern As String() = {"GGLLL", "GLGLL", "GLLGL", "GLLLG", "LGGLL", "LLGGL", _
...
#Region "Code128-specific"
  ...
  Private Shared Function ParseCode128Pattern(ByVal sPattern As String, ByRef sResult As String, ByRef uCheckSum As UInteger, ByRef cCodePage As Char, ByRef iCodes As Integer) As Integer
    Dim Code128 As String() = {"212222", "222122", "222221", "121223", "121322", "131222", _
     "122213", "122312", "132212", "221213", "221312", "231212", _
     "112232", "122132", "122231", "113222", "123122", "123221", _
     "223211", "221132", "221231", "213212", "223112", "312131", _
     "311222", "321122", "321221", "312212", "322112", "322211", _
     "212123", "212321", "232121", "111323", "131123", "131321", _
     "112313", "132113", "132311", "211313", "231113", "231311", _
     "112133", "112331", "132131", "113123", "113321", "133121", _
     "313121", "211331", "231131", "213113", "213311", "213131", _
     "311123", "311321", "331121", "312113", "312311", "332111", _
     "314111", "221411", "431111", "111224", "111422", "121124", _
     "121421", "141122", "141221", "112214", "112412", "122114", _
     "122411", "142112", "142211", "241211", "221114", "413111", _
     "241112", "134111", "111242", "121142", "121241", "114212", _
     "124112", "124211", "411212", "421112", "421211", "212141", _
     "214121", "412121", "111143", "111341", "131141", "114113", _
     "114311", "411113", "411311", "113141", "114131", "311141", _
