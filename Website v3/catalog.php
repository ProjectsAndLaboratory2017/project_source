	...
	<div class="container-fluid">
		...
		<div class="row rm">
			...
			<div class="col-md-4 text-center">
				<br /> <br /> <br /> <br />
				<a class="btn btn-success btn-text" href="view_customers.php">View Customers</a>
				<br /> <br /> <br /> <br />
			</div>
			<div class="col-md-4 text-center">
				<br /> <br /> <br /> <br />
				<a class="btn btn-success btn-text" href="my_profile.php">Manage Products</a>
				<br /> <br /> <br /> <br />
			</div>
			<div class="col-md-4 text-center">
				<br /> <br /> <br /> <br />
				<a class="btn btn-success btn-text" href="view_purchases.php">View Purchases</a>
				<br /> <br /> <br /> <br />
			</div>
