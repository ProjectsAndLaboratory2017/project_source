...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2017 at 10:08 AM
...
(1, 12345678, 'FEZ Spider II Mainboard', 15, 4, 50, 15),
(2, 123456789, 'Display TE35 Module', 10, 3, 10, 12),
(3, 234567890, 'USB Client EDP Module', 8.5, 10, 0, 2),
(4, 345678901, '2x Button Module', 5, 8, 15, 3),
(5, 456789012, 'Ethernet J11D Module', 9, 2, 7, 7),
(6, 567890123, 'Joystick Module', 6, 0, 4, 3),
(7, 678901234, 'LED Strip Module', 2, 10, 40, 3),
(8, 789012345, 'Light Sensor Module', 7, 8, 20, 9),
