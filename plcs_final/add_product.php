...
<script type='text/javascript'> 
	...
	function checkProductName(input) {  
		if(input.validity.patternMismatch)
			input.setCustomValidity("Product Name must be atleast 3 characters long and may contain alphabets, digits, - and _ sysmbols");    
		else 
			input.setCustomValidity("");  
	}
				...
				<h1 class="text-primary">Add Product</h1>
					...
					<form name="addproductform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="productName" id="productName" placeholder="Product Name" required="required" pattern="[a-zA-Z0-9-_ ]{3,100}" oninput="checkProductName(this)" />
							<br /> <br />
